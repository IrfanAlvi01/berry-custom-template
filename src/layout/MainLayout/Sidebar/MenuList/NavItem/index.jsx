...
import { setMenu } from '../../../../../redux/slices/customizationSlice';
...
const NavItem = ({ item, level }) => {
  ...
  const { isOpen, borderRadius } = useSelector((state) => state.customizationReducer);
  ...
  const itemHandler = (id) => {
    dispatch(setMenu(id));
    if (matchesSM) dispatch(setDrawer(false));
  };
